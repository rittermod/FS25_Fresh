...
Default shelf lives for all perishable products in Fresh. Values are in game months at Normal difficulty.
...
|---------|-----------|-------------|
| Strawberry | 1 month | Frozen |
| Spinach (bags) | 1 month | Frozen |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Enoki | 1 month | Frozen |
| Oyster | 1 month | Frozen |
...
Unpasteurized milk with very short shelf life.

| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Milk | 1 month | Cooled |
| Buffalo Milk | 1 month | Cooled |
| Goat Milk | 1 month | Cooled |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Bottled Milk | 1 month | Cooled |
| Bottled Goat Milk | 1 month | Cooled |
| Bottled Buffalo Milk | 1 month | Cooled |
| Egg | 2 months | Cooled |
| Buffalo Mozzarella | 2 months | Cooled |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Rice Saplings | 2 months | Indoor |
| Tree Saplings | 3 months | Indoor |
| Seeds | 24 months | Indoor |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Onion | 3 months | Cooled |
| Onion Bag | 3 months | Cooled |
| Sugar Beet | 5 months | Cooled |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Fried Onion | 6 months | Frozen |
| Onion Salt | 24 months | Indoor |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Jarred Green Bean | 18 months | Indoor |
| Canned Peas | 24 months | Indoor |
| Noodle Soup | 24 months | Indoor |
| Onion Soup | 24 months | Indoor |
| Soup (Beetroot) | 24 months | Indoor |
| Soup (Carrots) | 24 months | Indoor |
| Soup (Mixed) | 24 months | Indoor |
| Soup (Parsnip) | 24 months | Indoor |
| Soup (Potato) | 24 months | Indoor |
...
| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Raisins | 12 months | Indoor |
| Sugar | 36 months | Indoor |
...
These apply to fill types used when creating bales:

| Product | Shelf Life | Max Benefit |
|---------|-----------|-------------|
| Grass Windrow | 1 month | Sheltered |
| Dry Grass Windrow | 18 months | Sheltered |

*Bales undergoing fermentation (wrapped grass) pause aging until fermentation completes.*

---

## Non-Expiring Products

The following categories of products do not expire:

- **Farm supplies** - Fertilizer, herbicide, lime, liquid fertilizer, mineral feed, silage additive
- **Natural resources** - Cotton, wool, manure, liquid manure, digestate
- **Wood and construction** - Boards, planks, wood beams, cement, bricks, prefab walls
- **Manufactured goods** - Furniture, clothes, fabric, pianos, barrels, rope, tarp
- **Fuel and energy** - Diesel, DEF, electric charge, methane
- **Animals** - All animal fill types
- **Bale materials** - Net wrap, twine, wrapping film

*Non-expiring products are hidden from the Fresh Menu by default. Products not listed in the mod's configuration default to non-expiring.*

---

## DLC and Mod Products

Fresh automatically detects fill types added by DLCs, maps, and other mods. New fill types default to non-expiring unless you configure them in the Settings tab of the Fresh Menu. The settings distinguish between basegame products and DLC/mod products in separate tabs for easy management.
