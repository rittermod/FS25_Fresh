...
source(modDirectory .. "scripts/gui/frames/RmFillTypeDetailFrame.lua")
source(modDirectory .. "scripts/gui/frames/RmStorageDetailFrame.lua")
source(modDirectory .. "scripts/gui/frames/RmStatsFrame.lua")
source(modDirectory .. "scripts/gui/frames/RmShelfLifeFrame.lua")
